...
function ConfirmDeleteModal({ open, ticketId, loading, onClose, onConfirm }) {
  return (
    <ModalShell open={open} onClose={onClose} z={80}>
...
export default function CustomerTicketRow({ t, isOpen, onToggle, onDeleted, apiBase }) {
  ...
  return (
    <Fragment>
      {/* ✅ portals => no more div inside tbody */}
      <ConfirmDeleteModal
        open={deleteOpen}
        ticketId={id}
        loading={deleting}
