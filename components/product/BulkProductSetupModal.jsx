...
export default function BulkProductSetupModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm px-3 py-5 sm:p-6">
      {/* ✅ Modal Container */}
      <div className="w-full max-w-5xl rounded-3xl bg-white shadow-[0_20px_60px_rgba(0,0,0,0.20)] ring-1 ring-gray-200/60 flex flex-col max-h-[90vh] overflow-hidden">
        
        {/* ✅ Header (Sticky) */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 bg-gradient-to-b from-white to-gray-50 border-b border-gray-100">
          <div>
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 sm:px-6 py-5">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            {/* Descriptions + Tags */}
            <div className="md:col-span-2 rounded-2xl bg-white shadow-sm ring-1 ring-gray-200/60 p-4 sm:p-5">
        ...
        {/* ✅ Footer (Sticky) */}
        <div className="flex items-center justify-end gap-3 bg-gray-50 px-4 sm:px-6 py-4 border-t border-gray-100">
          <button
            onClick={onClose}
