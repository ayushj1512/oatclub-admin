...
/* ---------------------------------------------
   ...
   - ✅ Backend: fulfillmentStatus=cancelled + customerName=search
--------------------------------------------- */
export default function CancelledOrdersPage() {
  ...
  /* ---------------------------------------------
     ✅ CSV export
     - includes admin remarks + customer message
  --------------------------------------------- */
  const buildCsvRows = (ordersArr) => {
    ...
    for (const order of ordersArr || []) {
      ...
      const supportRemark = safe(order?.customerSupportRemark || "");
      ...
      if (!items.length) {
        rows.push({
          ...
          adminRemarks,
          customerMessage,
          customerSupportRemark: supportRemark,
          subtotal,
          discount,
          shippingFee,
          tax,
  ...
  const exportToCSV = () => {
    if (!filteredOrders?.length) return alert("No cancelled orders to export.");
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-6">
          <div>
            ...
            <div className="mt-4 flex items-center gap-3 text-sm text-gray-600">
              ...
              <span className="px-3 py-1 rounded-full bg-rose-50 text-rose-800 font-semibold">
                Status: cancelled
              </span>
            </div>
          </div>
