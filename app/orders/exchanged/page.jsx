...
/* ---------------------------------------------
   Page: Exchanged Orders
   - ✅ Only Searchbar (no filters)
   - ✅ Backend: fulfillmentStatus=exchanged + customerName=search
--------------------------------------------- */
export default function ExchangedOrdersPage() {
  ...
  /* ---------------------------------------------
     ✅ CSV export
     - includes latest RMA + exchangeRequest + fee info
  --------------------------------------------- */
  ...
  const exportToCSV = () => {
    if (!filteredOrders?.length) return alert("No exchanged orders to export.");
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-6">
          <div>
            ...
            <div className="mt-4 flex items-center gap-3 text-sm text-gray-600">
              ...
              <span className="px-3 py-1 rounded-full bg-indigo-50 text-indigo-800 font-semibold">
                Status: exchanged
              </span>
            </div>
          </div>
