...
export default function RmaClient() {
  ...
  <div className="flex items-center justify-between">
    ...
    <div className="text-sm text-gray-600">
      <span className="font-medium text-gray-900">{rmas?.length || 0}</span>{" "}
      requests
    </div>
  </div>
  ...
  {!loading && (!Array.isArray(rmas) || rmas.length === 0) && (
    <div className="rounded-xl bg-gray-50 border border-gray-100 px-5 py-10 text-center">
      ...
      <p className="text-sm text-gray-500 mt-1">
        Once customers raise RMAs, they’ll appear here.
      </p>
    </div>
  )}
